...
def read_csv_file():
    print("Reading financial data from CSV file...")
...
data_aggregation_agent=AssistantAgent(
    ...
    system_message="""
    You collect and aggregate financial data from the CSV file. for monthly financial report""",
)
...
report_generation_agent=AssistantAgent(
    ...
    llm_config=llm_config,
    system_message="""
    You generate detailed finacial reports based on the aggregate data
    """,
)
