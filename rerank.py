...
def generate_multiquery(query, context, model="gpt-3.5-turbo"):
    
    prompt=f""" 
       You are a knowlegeable financial research assistant.
...
res = generate_multiquery(query=original_query, context=context)
print("--------MULTIQUERY--------")
print("\n".join(res))